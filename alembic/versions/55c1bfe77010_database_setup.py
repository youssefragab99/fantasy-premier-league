...
down_revision: Union[str, Sequence[str], None] = "ae7f68270204"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("element_type", sa.Integer(), nullable=False, comment="Player's position: 1=GK, 2=DEF, 3=MID, 4=FWD"),
    ...
    op.create_table(
        ...
        sa.Column("value", sa.Integer(), nullable=True, comment="Player cost at the time of the gameweek"),
        sa.Column("selected", sa.Integer(), nullable=True, comment="Number of managers who selected the player"),
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["players.id"],
        ),
    ...
    op.create_index(
        op.f("ix_player_gameweek_history_player_id"), "player_gameweek_history", ["player_id"], unique=False
    )
    op.create_index(op.f("ix_player_gameweek_history_gameweek"), "player_gameweek_history", ["gameweek"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_player_gameweek_history_player_id"), table_name="player_gameweek_history")
